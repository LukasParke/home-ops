...
**Kubernetes (this repo):** NFS CSI, ReadWriteOnce volumes, and when to use Deployment `Recreate` are documented in [kubernetes/docs/storage-nfs.md](./kubernetes/docs/storage-nfs.md). Homepage inventory and widget conventions are documented in [kubernetes/docs/homepage.md](./kubernetes/docs/homepage.md).
